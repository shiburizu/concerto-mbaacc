...
class Caster():
    ...
    def auto_update(self):
        ...
        latest_release_tag_split = latest_release_tag.split('/')
        latest_release_tag = '%s-%s-%s' % (latest_release_tag_split[0], latest_release_tag_split[1], '20' + latest_release_tag_split[2])
